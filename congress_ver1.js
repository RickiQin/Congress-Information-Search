...
//        console.log("zhixing");
    $http.get("http://localhost/congress.php?cdb=legi").then(function(response){  
...
//        console.log("zhixing");
    $http.get("http://localhost/congress.php?cdb=abill").then(function(response){  
//            console.log("zhixingCTR");
...
//        console.log("zhixing");
    $http.get("http://localhost/congress.php?cdb=nbill").then(function(response){  
//            console.log("zhixingCTR");
...
//        console.log("zhixing");
    $http.get("http://localhost/congress.php?cdb=commi").then(function(response){  
//            console.log("zhixingCTR");
...
//      console.log(obj);
      ...
      //get bills
      $http.get("http://localhost/congress.php?keyword=detailbill&obj="+obj).then(function(resp){
...
//      $scope.selectedbill = obj;
      ...
      //get bills
      $http.get("http://localhost/congress.php?keyword=billdetail&obj="+obj).then(function(resp){
